...
const gilmarLaunchXDev = new LaunchXStudent("gilmar", "js", ["elixir", "groovy", "lisp"])
console.log(gilmarLaunchXDev)
console.log(gilmarLaunchXDev.getName) // getter de la clase padre rehusada en la clase hija